...
function sendEmail(template) {
  try {
    ...
    var templatePath    = config.path.build + '/' + template + '.html';
    ...
    if (e.code == 'ENOENT') {
      console.log('An error occurred. Check whether the provided template name is correct and the template exists in the ' + config.path.build + ' directory.');
